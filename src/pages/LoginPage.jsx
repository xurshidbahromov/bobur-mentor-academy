...
export default function LoginPage() {
  ...
  // Hero text collapses over the first 160px of scroll
  ...
  // Navbar stays readable: shrinks slightly but stays visible
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-base)' }}>
      <style>{`
        ...
        @keyframes loginOrb { 0%,100%{transform:translateY(0) scale(1)} 50%{transform:translateY(-30px) scale(1.08)} }
      `}</style>
      ...
      <div style={{
        ...
        {/* Orbs */}
        <div style={{ position:'absolute', top:-60, right:-40, width:320, height:320, borderRadius:'50%', background:'radial-gradient(circle,rgba(34,158,217,0.22) 0%,transparent 70%)', filter:'blur(50px)', animation:'loginOrb 14s ease-in-out infinite', pointerEvents:'none' }} />
        <div style={{ position:'absolute', top:'50%', left:-80, width:300, height:300, borderRadius:'50%', background:'radial-gradient(circle,rgba(52,97,255,0.2) 0%,transparent 65%)', filter:'blur(50px)', animation:'loginOrb 18s ease-in-out infinite reverse', pointerEvents:'none' }} />
        <div style={{ position:'absolute', bottom:-40, right:'20%', width:220, height:220, borderRadius:'50%', background:'radial-gradient(circle,rgba(139,92,246,0.15) 0%,transparent 65%)', filter:'blur(50px)', animation:'loginOrb 22s ease-in-out infinite', pointerEvents:'none' }} />
        ...
        {/* ── GLASS CARD (scrolls up over the hero) ── */}
