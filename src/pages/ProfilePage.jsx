...
export default function ProfilePage() {
  ...
  const AVATAR_PRESETS = [
    ...
    'https://api.dicebear.com/7.x/adventurer/svg?seed=Koala',
    'https://api.dicebear.com/7.x/adventurer/svg?seed=Otter',
    'https://api.dicebear.com/7.x/adventurer/svg?seed=Deer',
    'https://api.dicebear.com/7.x/adventurer/svg?seed=Eagle',
    'https://api.dicebear.com/7.x/adventurer/svg?seed=Hawk'
  ]
  ...
  return (
    <>
      <style>{`
        .profile-page-wrapper { width: 100%; padding-bottom: 50px; background: #F8FAFC; min-height: 100vh; }
        .profile-container { max-width: 1100px; margin: 0 auto; padding: 0 20px; position: relative; z-index: 2; }
        ...
        @media (max-width: 768px) {
          ...
          .bento-grid { gap: 12px; }
          .bento-item { padding: 16px; border-radius: 16px; border-width: 2px; }
        } }
      `}</style>
            ...
            <div style={{ maxWidth: 800 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                <div style={{ padding: '4px 10px', background: 'rgba(255,255,255,0.1)', borderRadius: 100, border: '1px solid rgba(255,255,255,0.15)', display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                  ...
                  <span style={{ color: '#DBEAFE', fontSize: '0.625rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Profil Markazi</span>
                </div>
              </div>
          ...
          <motion.div variants={container} initial="hidden" animate="show" className="bento-grid">
            ...
            <motion.div variants={item} className="bento-item col-span-4 glass-card-premium card-glow-hover glow-sky" style={{ 
              ...
              <button
                ...
                style={{
                  position: 'absolute', top: 12, right: 12, border: 'none', background: 'rgba(52,97,255,0.08)',
                  borderRadius: 10, padding: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center',
              ...
              <div style={{
                position: 'relative', marginBottom: 16, padding: 4, borderRadius: '50%',
                ...
                {avatarUrl ? (
                  <img src={avatarUrl} alt={name} loading="lazy" style={{
                    ...
                    border: '3.5px solid white', display: 'block', backgroundColor: '#F8FAFC'
                  }} />
                ) : (
                  <div style={{
                    width: 80, height: 80, borderRadius: '50%',
                    background: '#F1F5F9', border: '3.5px solid white',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: '2rem', fontWeight: 900, color: '#475569',
                  }}>
              ...
              <h2 className="outfit-font" style={{ margin: '0 0 4px', fontSize: '1.25rem', fontWeight: 900, color: '#0F172A', letterSpacing: '-0.02em' }}>
                {name}
              </h2>
              <p style={{ margin: '0 0 12px', color: '#64748B', fontSize: '0.8125rem', fontWeight: 500 }}>
                {email}
              </p>

              {isAdmin && (
                <div style={{
                  display: 'inline-flex', alignItems: 'center', gap: 5, background: '#EFF6FF',
                  color: '#3461FF', padding: '4px 12px', borderRadius: 100, fontSize: '0.75rem', fontWeight: 700,
                }}>
            ...
            <motion.div variants={item} className="bento-item col-span-8 glass-card-premium card-glow-hover glow-purple" style={{ display: 'flex', alignItems: 'center', gap: 24, flexWrap: 'wrap' }}>
              ...
              <div style={{ flex: '1 1 200px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                  ...
                  <div>
                    <h3 className="outfit-font" style={{ margin: 0, fontWeight: 800, color: '#0F172A', fontSize: '1.125rem' }}>Akademik Daraja</h3>
                    <p style={{ margin: 0, color: '#64748B', fontSize: '0.8125rem', fontWeight: 500 }}>Platformadagi umumiy reytingingiz</p>
                  </div>
                </div>
                
                <p style={{ color: '#475569', fontSize: '0.875rem', lineHeight: 1.5, marginBottom: 16 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <span style={{ fontWeight: 800, color: '#8B5CF6', fontSize: '0.8125rem' }}>{xpInCurrentLevel} / 100 XP</span>
                </div>
              </div>
              ...
              <div style={{ position: 'relative', width: 110, height: 110, flexShrink: 0, margin: '0 auto' }}>
                ...
                <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                  <span className="outfit-font" style={{ fontSize: '2rem', fontWeight: 900, color: '#0F172A', lineHeight: 1, letterSpacing: '-0.04em' }}>{currentLevel}</span>
                  <span style={{ fontSize: '0.625rem', fontWeight: 800, color: '#64748B', textTransform: 'uppercase', letterSpacing: '0.05em', marginTop: 1 }}>Level</span>
                </div>
              </div>
            ...
            <motion.div variants={item} className="bento-item col-span-12 glass-card-premium card-glow-hover glow-amber" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{
                  ...
                  {canClaim ? <Zap color="white" size={20} fill="white" /> : <CheckCircle2 color="#94A3B8" size={20} />}
                </div>
                <div>
                  <h3 className="outfit-font" style={{ margin: '0 0 2px', fontWeight: 800, fontSize: '1.125rem', color: '#0F172A' }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 800, fontSize: '0.875rem', cursor: canClaim ? 'pointer' : 'default',
                  transition: 'transform 0.2s',
                  boxShadow: canClaim ? '0 6px 16px rgba(245,158,11,0.25)' : 'none'
                }}
              >
            ...
            <motion.div variants={item} className="col-span-6" style={{
              ...
              {STATS.map((s, i) => {
                ...
                return (
                <div key={i} className={`bento-item glass-card-premium card-glow-hover ${glowClass}`} style={{ padding: '16px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 12 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <div style={{ width: 32, height: 32, borderRadius: 8, background: s.bg, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      {s.icon}
                    </div>
                    <span style={{ fontWeight: 700, color: '#64748B', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.02em' }}>
                      {s.label}
                    </span>
                  </div>
                  <div style={{ fontSize: '1.625rem', fontWeight: 900, color: '#0F172A', lineHeight: 1, fontFamily: '"Outfit", sans-serif' }}>
                    {s.value}
                  </div>
                </div>
              )})}
            ...
            <motion.div variants={item} className="bento-item col-span-6 glass-card-premium card-glow-hover glow-green" style={{ display: 'flex', flexDirection: 'column' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <h3 className="outfit-font" style={{ margin: 0, fontWeight: 800, color: '#0F172A', fontSize: '1.125rem' }}>Aktivlik</h3>
                </div>
                <span style={{ background: '#F1F5F9', color: '#475569', padding: '3px 10px', borderRadius: 100, fontSize: '0.75rem', fontWeight: 700 }}>
            ...
            <motion.div variants={item} className="bento-item col-span-12 glass-card-premium card-glow-hover glow-sky" style={{ padding: 12 }}>
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                {MENU_GROUPS[0].items.map((m, j) => (
                  ...
                  >
                    <div style={{ width: 32, height: 32, borderRadius: 8, background: m.iconBg, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      {m.icon}
                    </div>
                    <span style={{ flex: 1, fontWeight: m.bold ? 800 : 600, color: m.labelColor || '#0F172A', fontSize: '0.9375rem' }}>
                      {m.label}
                    </span>
                ...
                <div style={{ height: 1, background: '#F1F5F9', margin: '6px 12px' }} />
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 12, cursor: 'pointer', transition: 'background 0.2s ease'
                  }}
                ...
                >
                  ...
                  <span style={{ flex: 1, fontWeight: 700, color: '#EF4444', fontSize: '0.9375rem' }}>
                    Tizimdan chiqish
                  </span>
                </button>
              </div>
